...
Future<http.Response> consultarLugar(String id) {
  return http.get(Uri.parse('http://localhost:5000/espacios?id=$id'));
}

Future<http.Response> seleccionarLugares() {
  return http.get(Uri.parse('http://localhost:5000/espacios'));
}
...
Future<http.Response> crearAdmin(
    String rfc, String curp, String passwd, String nombre) {
  return http.post(
